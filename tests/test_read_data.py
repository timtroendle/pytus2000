...
DIARY_FILE_MISSING_MSG = "Original diary file does not exist, expected here '{}'."\
    .format(PATH_TO_DIARY_FILE)


@pytest.fixture(params=[
    PATH_TO_DIARY_HEADER_FILE,
    pytest.mark.skipif(not PATH_TO_DIARY_FILE.exists(),
                       reason=DIARY_FILE_MISSING_MSG)(PATH_TO_DIARY_FILE)
])
